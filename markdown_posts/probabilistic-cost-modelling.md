...
date: 2026-07-11
category: statistics
tags: probability, distributions, heavy-tails, budgeting
---
...
![What's at stake: budget reserve under correct vs wrong distributional assumption](../figures/probabilistic-cost-modelling/wrong_distribution_impact.png)
...
![Candidate distributions fitted to the same salary data](../figures/probabilistic-cost-modelling/distribution_zoo.png)
...
![MLE Convergence: estimates converge to true parameters as n grows](../figures/probabilistic-cost-modelling/mle_convergence.png)
...
![Model comparison: AIC, BIC, and Akaike weights](../figures/probabilistic-cost-modelling/model_comparison.png)
...
![Mixture detection: GMM identifies bimodal structure](../figures/probabilistic-cost-modelling/mixture_detection.png)
...
![Tail risk comparison: Normal vs Pareto](../figures/probabilistic-cost-modelling/tail_risk_comparison.png)
