...
![Convergence of $P^n$ to the rank-1 stationary matrix](../figures/headcount-dynamics/transition_convergence_heatmap.png)
...
![Eigenvalue spectrum and spectral gap](../figures/headcount-dynamics/eigenvalue_spectrum.png)
...
![Expected absorption time per starting level, with $\pm 1\sigma$ error bars](../figures/headcount-dynamics/absorption_times.png)
...
![Birth-death stationary: $\pi_n$ is Poisson($\rho$)](../figures/headcount-dynamics/birth_death_stationary.png)
...
![Kolmogorov trajectory with 5–95% band](../figures/headcount-dynamics/kolmogorov_trajectory.png)
...
![Scenario S1 — steady growth](../figures/headcount-dynamics/scenario_s1_steady_growth.png)
...
![Scenario S2 — hiring freeze](../figures/headcount-dynamics/scenario_s2_hiring_freeze.png)
...
![Scenario S3 — layoff recovery](../figures/headcount-dynamics/scenario_s3_layoff_recovery.png)
...
![Scenario S4 — composition shift](../figures/headcount-dynamics/scenario_s4_composition_shift.png)
...
![Scenario S5 — seasonal hiring](../figures/headcount-dynamics/scenario_s5_seasonal_hiring.png)
...
![Sensitivity tornado](../figures/headcount-dynamics/sensitivity_tornado.png)
...
![Birth-death steady state — empirical histogram vs Poisson](../figures/headcount-dynamics/birth_death_steady_simulation.png)
