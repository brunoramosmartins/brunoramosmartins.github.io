...
![Experiment A: raw agreement $A_o$ tracks the chance baseline $1/K$ (shaded region), reaching 0.5 at $K=2$, while Fleiss' $\kappa_F$ and Krippendorff's $\alpha$ stay at zero for random i.i.d. raters.](../figures/krippendorff-alpha/exp_a_random_metrics.png)
...
![Experiment D: Krippendorff's $\alpha$ holds near its complete-data value as MCAR missingness rises, while Fleiss' $\kappa$ is undefined beyond 0% missing and complete-case deletion keeps only a shrinking sliver of items.](../figures/krippendorff-alpha/exp_d_missing_robustness.png)
